...
class Popup extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            text: 'This is a quiz application built to test the SS2 & SS33 students. <br /><br /> Currently it\'s loaded with past questions, and it will be updated regularly. <br /><br /> It will dynamically load the question->answers pair and upload them into the components.' ,
